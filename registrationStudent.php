        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="page-content">
										...
										{											
											...
											{
												$aerr='fill your school name';
												$state="false";
											}
											if(empty($_POST["grade"]))
											{
												$berr='Please fill your grade';
												$state="false";
											}
											if(empty($_POST["uname"]))
											{
												$cerr='Please fill your username';
												$state="false";
											}
											if(empty($_POST["pass"]))
											{
												$derr='Please fill your password';
												$state="false";
											}
											if(empty($_POST["cpass"]))
											{
												$eerr='Please refill your password';
												$state="false";
											}
											if(strlen($_POST["uname"])>10)
											{
												$cerr='Username must be less than 10';
												$state="false";
											}
											if($_POST["pass"]!=$_POST["cpass"])
											{
												$eerr='Passwords doesnot match';
												$state="false";
											}
											if($state=="true")
												{
															include 'config.php'; 
															$sql= "INSERT into registrationstudent(school_name, grade, username, password) 
																	VALUES('$_POST[schoolname]',
																			'$_POST[grade]',
																			'$_POST[uname]',
																			'$_POST[pass]')";
						...
						<form method="POST" name="Form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" style="margin:5% auto;width:400px;min-height:600px;background:white;padding:2.5% 5% 2.5%;border-radius:2.5%;">
														  ...
														  <br>
														  <label for="names" style="color:#BDC3C7;text-transform:uppercase;font-size:0.8em;letter-spacing:4px;">Name of School</label>
														  <br>
														  <input id="names" type="text" name="schoolname" style="margin:5% 0;border:none;width:100%;font-size:1.5em;padding:0 0 2%;background:none;border-bottom:2px solid #8cca8c;">
														  <span style="color:red"><?php echo $aerr; ?> </span>
														  <br>
														  <label for="grade" style="color:#BDC3C7;text-transform:uppercase;font-size:0.8em;letter-spacing:4px;">Grade</label>
														  <br>
														  <input id="grade" type="text" name="grade" style="margin:5% 0;border:none;width:100%;font-size:1.5em;padding:0 0 2%;background:none;border-bottom:2px solid #8cca8c;">
				...
				filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=#8cca8c, endColorstr=#fbd75c,GradientType=1 ); /* IE6-9 */ ">
														  <br>
														  <a href="login.php"  style="color:#BDC3C7;text-transform:uppercase;font-size:0.8em;letter-spacing:4px;">Already have an account?</a>
														  <a href="registrationLecturer.php"  style="color:#BDC3C7;text-transform:uppercase;font-size:0.8em;letter-spacing:4px;">Want to register as Lecturer?</a>
														</form>
